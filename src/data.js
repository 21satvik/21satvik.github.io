...
export const PROJECTS = [
  ...
  },
  {
    slug: "enable",
    name: "enAble",
    tagline: "Accessibility mapping for people who need it most.",
    year: "2022",
    status: "Complete",
    category: "Mobile · Accessibility",
    description: "An app for storing and sharing accessibility information about buildings, offices, and public spaces — useful for people with disabilities. Won 1st Runner-up at Ultron 5.0 Hackathon.",
    challenge: "Build something genuinely useful for accessibility in 48 hours.",
    outcome: "1st Runner-up, Ultron Hackathon, SRMIST. 5 GitHub stars.",
    tags: ["Flutter", "Firebase", "Dart", "Maps API"],
    link: "https://github.com/21satvik/enAble-mobile-app",
    linkLabel: "GitHub",
  },
  {
    slug: "exchange-predictor",
    name: "Exchange Rate Predictor",
    tagline: "Time series forecasting for currency markets.",
    year: "2023",
    status: "Complete",
    category: "ML · Finance",
    description: "A machine learning model to forecast exchange rates using historical data — combining financial data with predictive modelling before I had the business context to know what to do with the output.",
    challenge: "Predict something notoriously hard to predict — and learn what the model's limits actually are.",
    outcome: "Built solid intuition for time series modelling. The missing piece back then was business context — knowing what to do with the output. That's exactly what the analytics work I do now is built on.",
    tags: ["Python", "Time Series", "ML", "Pandas"],
    link: "https://github.com/21satvik/Exchange-rate-predictor",
    linkLabel: "GitHub",
  },
  {
    slug: "alloys",
    name: "Production of Alloys",
    tagline: "Carbon taxes and trade tariffs change the cost structure. The model had to as well.",
    year: "2025",
    status: "Complete",
    category: "Linear Programming · Policy",
    description: "Started with a classical alloy-blending LP, then extended it into something that reflects how steel producers actually operate today. The model covers two export markets (EU and US), internalises EU ETS/CBAM carbon pricing (€85/tCO₂), and applies destination-specific US Section 232 tariffs (50%). Implemented in FICO Xpress Mosel with external data files for clean scenario switching.",
