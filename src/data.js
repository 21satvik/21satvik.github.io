...
export const PROJECTS = [
  {
    slug: "revenue-manager-agent",
    name: "Revenue Manager Agent",
    tagline: "An AI revenue analyst that can't make up a number.",
    year: "2026",
    status: "Complete",
    category: "Agentic AI · Data Engineering",
    description: "A hotel Revenue Manager agent built on LangChain Deep Agents over a Postgres reservation book. It answers a GM's commercial questions — on-the-books revenue, segment and channel mix, booking pace, cancellations, point-in-time snapshots — in plain English, like a morning commercial briefing. Every figure comes from five typed, tested tools that read semantic SQL views, never raw tables. The full agent surface is there: eight on-demand skills, a quarantined sub-agent, a human-in-the-loop approval gate, multi-turn memory, an MCP server exposing the same tools, and a FastAPI chat UI that streams each tool and skill call live.",
    challenge: "Ask a chatbot for August revenue and it gives you a confident, plausible, possibly wrong number. For a GM making pricing calls, a hallucinated figure is worse than no answer. The numbers could not be left to the model improvising SQL.",
    outcome: "Correctness lives in code, not the prompt. Grain (reservations vs stay-rows vs room-nights), default filters, and date logic are enforced in a tested tool layer with no run_sql — covered by 37 tests. Five tools, eight skills, an MCP server, and a live-streaming UI; swap the model and the tone changes, not the numbers.",
    tags: ["Python", "LangChain Deep Agents", "PostgreSQL", "MCP", "FastAPI", "Agentic AI"],
    link: "https://github.com/21satvik/revenue-manager-agent",
    linkLabel: "GitHub",
  },
  {
    slug: "busconnects",
  ...
  {
    slug: "forestry-dss",
    name: "Ireland Afforestation DSS",
    tagline: "No single species wins. Built a DSS that shows why.",
    year: "2026",
    status: "Complete",
    category: "Decision Support · Tableau · Multi-Criteria Optimisation",
    description: "A six-dashboard Tableau DSS for Ireland's afforestation challenge — 447,528 ha gap from the 18% national target. Built a weighted scoring engine across four dimensions (carbon, finance, ecology, resilience) with 12 user-controlled parameters. The Strategy Sankey reranks species allocations live as priorities shift. Data from the UK Woodland Carbon Code, DAFM grant schemes, and Irish Soil Information System, linked through fuzzy soil matching.",
    challenge: "No single species dominates every dimension. Sitka Spruce leads carbon but scores 4/15 on ecology. The DSS had to make that trade-off visible and adjustable, not hide it behind a single composite number.",
    outcome: "Equal-weight strategy favours Sessile Oak (24%) and Common Alder (22%). Shifting to carbon-first flips the ranking to Sitka Spruce. The model reveals that policy must be explicit about priorities before species allocation can be defended.",
    tags: ["Tableau", "Python", "Data Modelling", "Multi-Criteria Analysis", "ETL", "Data Visualisation"],
    link: "https://public.tableau.com/app/profile/satvik.kumar3682/viz/Group25-MIS41040/LandingPage",
    linkLabel: "Dashboard",
    report: "/pdf/forestry_dss_report.html",
  },
  {
