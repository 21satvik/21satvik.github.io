 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(E,_){var L=E.length;E.push(_);e:for(;0<L;){var Q=L-1>>>1,q=E[Q];if(0<o(q,_))E[Q]=_,E[L]=q,L=Q;else break e}}function r(E){return E.length===0?null:E[0]}function n(E){if(E.length===0)return null;var _=E[0],L=E.pop();if(L!==_){E[0]=L;e:for(var Q=0,q=E.length,pn=q>>>1;Q<pn;){var jt=2*(Q+1)-1,Ao=E[jt],bt=jt+1,mn=E[bt];if(0>o(Ao,L))bt<q&&0>o(mn,Ao)?(E[Q]=mn,E[bt]=L,Q=bt):(E[Q]=Ao,E[jt]=L,Q=jt);else if(bt<q&&0>o(mn,L))E[Q]=mn,E[bt]=L,Q=bt;else break e}}return _}function o(E,_){var L=E.sortIndex-_.sortIndex;return L!==0?L:E.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var c=[],u=[],h=1,m=null,g=3,y=!1,x=!1,w=!1,S=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(E){for(var _=r(u);_!==null;){if(_.callback===null)n(u);else if(_.startTime<=E)n(u),_.sortIndex=_.expirationTime,t(c,_);else break;_=r(u)}}function v(E){if(w=!1,p(E),!x)if(r(c)!==null)x=!0,Ro(b);else{var _=r(u);_!==null&&Mo(v,_.startTime-E)}}function b(E,_){x=!1,w&&(w=!1,f(P),P=-1),y=!0;var L=g;try{for(p(_),m=r(c);m!==null&&(!(m.expirationTime>_)||E&&!_e());){var Q=m.callback;if(typeof Q=="function"){m.callback=null,g=m.priorityLevel;var q=Q(m.expirationTime<=_);_=e.unstable_now(),typeof q=="function"?m.callback=q:m===r(c)&&n(c),p(_)}else n(c);m=r(c)}if(m!==null)var pn=!0;else{var jt=r(u);jt!==null&&Mo(v,jt.startTime-_),pn=!1}return pn}finally{m=null,g=L,y=!1}}var C=!1,z=null,P=-1,G=5,R=-1;function _e(){return!(e.unstable_now()-R<G)}function yr(){if(z!==null){var E=e.unstable_now();R=E;var _=!0;try{_=z(!0,E)}finally{_?xr():(C=!1,z=null)}}else C=!1}var xr;if(typeof d=="function")xr=function(){d(yr)};else if(typeof MessageChannel<"u"){var ra=new MessageChannel,Xu=ra.port2;ra.port1.onmessage=yr,xr=function(){Xu.postMessage(null)}}else xr=function(){S(yr,0)};function Ro(E){z=E,C||(C=!0,xr())}function Mo(E,_){P=S(function(){E(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(E){E.callback=null},e.unstable_continueExecution=function(){x||y||(x=!0,Ro(b))},e.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<E?Math.floor(1e3/E):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return r(c)},e.unstable_next=function(E){switch(g){case 1:case 2:case 3:var _=3;break;default:_=g}var L=g;g=_;try{return E()}finally{g=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(E,_){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var L=g;g=E;try{return _()}finally{g=L}},e.unstable_scheduleCallback=function(E,_,L){var Q=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?Q+L:Q):L=Q,E){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=L+q,E={id:h++,callback:_,priorityLevel:E,startTime:L,expirationTime:q,sortIndex:-1},L>Q?(E.sortIndex=L,t(u,E),r(c)===null&&E===r(u)&&(w?(f(P),P=-1):w=!0,Mo(v,L-Q))):(E.sortIndex=q,t(c,E),x||y||(x=!0,Ro(b))),E},e.unstable_shouldYield=_e,e.unstable_wrapCallback=function(E){var _=g;return function(){var L=g;g=_;try{return E.apply(this,arguments)}finally{g=L}}}})(Os);As.exports=Os;var jd=As.exports;/**
 * @license React
